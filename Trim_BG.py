...
# I2C_WRITE(device_address=0x68,field_info={'fieldname': 'tdm_bclk_osr', 'length': 2, 'registers': [{'REG': '0x00', 'POS': 6, 'RegisterName': 'Config REG1', 'RegisterLength': 8, 'Name': 'tdm_bclk_osr[1:0]', 'Mask': '0xC0', 'Length': 2, 'FieldMSB': 1, 'FieldLSB': 0, 'Attribute': 'NNNNNNNN', 'Default': '00', 'User': '000YYYYY', 'Clocking': 'FRO', 'Reset': 'C', 'PageName': 'PAG0'}]},write_value=0x5)
