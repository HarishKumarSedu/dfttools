def apply_signal_measure(g, signal, reference, meas_type,expected_value ,*args, **kwargs):
    """
    Check signal measurement hardware availability and get measurement via callback.
    """
